-- Créer quelques profils de test pour que le matching fonctionne
...
(
  ...
  75, 80, 60, 85, 70, ARRAY[4,4,3,2,4,4,5,2,4,3], true,
...
(
  ...
  90, 75, 45, 70, 80, ARRAY[5,4,2,3,4,4,4,1,5,4], true,
  '[{"language": "Français", "level": "Natif"}, {"language": "Anglais", "level": "Courant"}]'::jsonb
),
(
  ...
  80, 85, 90, 75, 65, ARRAY[4,5,5,2,3,5,4,1,4,2], true,
